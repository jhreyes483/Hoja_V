...
<head>
  ...
  <meta name="description" content="Hoja de vida desarrollo web soporte sistemas">
  <meta name="Javier Reyes Neira" content="Hoja de vida tecnologo en sistemas">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
      <span class="d-block d-lg-none">Javier Reyes Neira</span>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#about">Perfil Profesional</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="https://jfa.herokuapp.com/">Portafolio</a>
        </li>
      </ul>
    </div>
  </nav>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
      <div class="w-100">
        ...
        <div class="social-icons">
          ...
          <a  target="_blank" href="https://github.com/jhreyes483">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex justify-content-center" id="experience">
      <div class="w-100">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          ...
          <div class="resume-date text-md-right">
            <span class="text-primary">29 / sep / 18 - 20 / jul / 20</span>
          </div>
        </div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          ...
          <div class="resume-date text-md-right">
            <span class="text-primary">12 / Jul / 17 - 14 / sep / 18 </span>
          </div>
        </div>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="education">
      <div class="w-100">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          ...
          <div class="resume-date text-md-right">
            <span class="text-primary">Enero 2019 - Enero 2021</span>
          </div>
        </div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          ...
          <div class="resume-date text-md-right">
            <span class="text-primary">Enero 2015 - Diciembre 2016</span>
          </div>
        </div>
           ...
           <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0">BACHILLER</h3>
            <div class="subheading mb-3">CAFAM</div>
            <p>Certificado</p>
          </div>
          <div class="resume-date text-md-right">
           ...
           <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="education">
      <div class="w-100">
        <h2 class="mb-5">Otros estudios</h2>

        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0">ENGLISH DOT WORK 2</h3>
            <div class="subheading mb-3">SENA</div>
            <p>Virtual = 60 horas</p>
          </div>
          <div class="resume-date text-md-right">
            <span class="text-primary"></span>
          </div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            <h3 class="mb-0">ENGLISH DOT WORK 1</h3>
            <div class="subheading mb-3">SENA</div>
            <p>Virtual - 60 horas</p>
          </div>
          <div class="resume-date text-md-right">
         ...
         <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            <h3 class="mb-0">ENGLISH DOT WORKS BEGINNER</h3>
            <div class="subheading mb-3">SENA</div>
            <p>Virtual - 60 horas</p>
          </div>
          <div class="resume-date text-md-right">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            <h3 class="mb-0">METODOLOGIAS DE PROGRAMACION</h3>
            <div class="subheading mb-3">SENA</div>
            <p>Virtual - 60 horas</p>
          </div>
          <div class="resume-date text-md-right">
           ...
           <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            <h3 class="mb-0">DISEÑO Y DESARROLLO DE SITIOS WEB ACCESIBLES</h3>
            <div class="subheading mb-3">SENA</div>
            <p>Virtual - 60 horas</p>
          </div>
          <div class="resume-date text-md-right">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            <h3 class="mb-0">BASES DE DATOS, SISTEMAS DE GESTION</h3>
            <div class="subheading mb-3">SENA</div>
            <p>Virtual - 60 horas</p>
          </div>
          <div class="resume-date text-md-right">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            <h3 class="mb-0">COMPUERTAS LOGICAS, CIRCUITOS INTEGRADOS</h3>
            <div class="subheading mb-3">SENA</div>
            <p>Virtual - 60 horas</p>
          </div>
          <div class="resume-date text-md-right">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            <h3 class="mb-0">ELECTRONICA: LEYES Y APLICACIONES</h3>
            <div class="subheading mb-3">SENA</div>
            <p>Virtual - 40 horas</p>
          </div>
          <div class="resume-date text-md-right">
            <span class="text-primary"></span>
          </div>          
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            <h3 class="mb-0">ITIL V3 Fundamentos</h3>
            <div class="subheading mb-3">AXELOS</div>
            <p>Presencial</p>
          </div>
          <div class="resume-date text-md-right">
            <span class="text-primary"></span>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            ...
            <div class="subheading mb-3">Linkedin</div>
            <p>Virtual</p>
          </div>
          <div class="resume-date text-md-right">
            <span class="text-primary"></span>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
          <div class="resume-content">
            ...
            <div class="subheading mb-3">Universidad compensar</div>
            <p>Presencial - 40 horas</p>
          </div>
          <div class="resume-date text-md-right">
            <span class="text-primary"></span>
          </div>          
